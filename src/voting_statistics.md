...
📈 88% avg. member participation (-3% vs. Jun)
💬 83% avg. member feedback rate (-3% vs. Jun)
```
...
📈 86% avg. member participation (-1% vs. Jun)
💬 82% avg. member feedback rate (+5% vs. Jun)
```
...
📈 91% avg. member participation (-2% vs. May)
💬 86% avg. member feedback rate (-3% vs. May)
```
...
📈 87% avg. member participation (+2% vs. May)
💬 77% avg. member feedback rate (+27% vs. May)
```
...
📈 93% avg. member participation (+3% vs. Apr)
💬 89% avg. member feedback rate (+4% vs. Apr)
```
...
📈 85% avg. member participation (-10% vs. Apr)
💬 50% avg. member feedback rate (-35% vs. Apr)
```
...
📈 90% avg. member participation (+7% vs Mar)
💬 85% avg. member feedback rate (+14% vs Mar)
```
...
📈 95% avg. member participation
💬 85% avg. member feedback rate
```
...
📈 83% avg. member participation (-7% vs Feb)
💬 71% avg. member feedback rate (-8% vs Feb)
```
...
📈 90% avg. member participation (+7% vs Jan)
💬 79% avg. member feedback rate (+10% vs Jan)
```
...
📈 83% avg. member participation (+19% vs pre-Jan)
💬 69% avg. member feedback rate (+23% vs pre-Jan)
```
...
📈 64% avg. member participation
💬 46% avg. member feedback rate
```